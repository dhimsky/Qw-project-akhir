...
<head>
  ...
  <link href="{{ asset('/') }}assets/img/Logo.png" rel="Qwords">
...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
        <h1 class="logo me-auto"><a style="font-family: Arial, Helvetica, sans-serif; font-weight: bold" href="#">Qwords<img src="assets/img/Qwords.png" alt=""></a></h1>
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a href="https://qwords.com/v2/promotion" class="promo-link">Promo</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                <img src="assets/img/Qwords.png" class="img-fluid animated" alt="">
            </div>
        </div>
    </div>
</section>
...
<main id="main">
          ...
          <div class="section-title">
            ...
            <div class="row">
              <div class="col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
                  <div class="box">
                      ...
                      <h2>VCH1</h2>
                      <h3><sup>Rp </sup><strike>24.500</strike></h3>
                      <h4><sup>Rp </sup>14.500</h4>
                      <ul>
                          <li><i class="bx bx-check"></i> Disk <span class="spectext">3 GB</span></li>
                          <li><i class="bx bx-check"></i> Bandwith <span class="spectext">Unlimited</span></li>
              ...
              <div class="col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
                <div class="box">
                    ...
                    <h2>HPCH Bisnis 1</h2>
                    <h3><sup>Rp </sup><strike>90.000</strike></h3>
                    <h4><sup>Rp </sup>79.000</h4>
                    <ul>
                      <li><i class="bx bx-check"></i> Disk <span class="spectext">3 GB</span></li>
                      <li><i class="bx bx-check"></i> Bandwith <span class="spectext">Unlimited</span></li>
              ...
              <div class="col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
                <div class="box">
                    ...
                    <h2>Signature</h2>
                    <h3><sup>Rp </sup><strike>109.000</strike></h3>
                    <h4><sup>Rp </sup>89.900</h4>
                    <ul>
                      <li><i class="bx bx-check"></i> Disk <span class="spectext">Unlimited</span></li>
                      <li><i class="bx bx-check"></i> Bandwith <span class="spectext">Unlimited</span></li>
                      <li><i class="bx bx-check"></i> Core CPU <span class="spectext">1 Core</span></li>
            ...
            <div class="col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
              <div class="box">
                ...
                <h2>VPS SC1</h2>
                <h3><sup>Rp </sup><strike>135.000</strike></h3>
                <h4><sup>Rp </sup>75.000</h4>
                <ul>
                  <li><i class="bx bx-check"></i> Disk <span class="spectext">25 GB</span></li>
                  <li><i class="bx bx-check"></i> Bandwith <span class="spectext">Unlimited</span></li>
                  <li><i class="bx bx-check"></i> Core CPU <span class="spectext">1 Core</span></li>
        ...
        <div class="faq-list">
          <ul>
            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Apa itu web hosting? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                  ...
                  <br><br>Penjelasan lebih lanjut dapat Anda baca pada artikel ini : https://qwords.com/blog/apa-itu-hosting/
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Ada berapa jenis hosting di Qwords? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="300">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Apa kelebihan dari cloud hosting Qwords? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="400">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">Mengapa saya perlu web hosting? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">Bagaimana cara membeli hosting? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-6" class="collapsed">Apakah saya bisa transfer Hosting ke Qwords Cloud Web Hosting Indonesia? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>PT. Qwords Company International</span></strong>
      </div>
    </div>
  </footer><!-- End Footer -->

  <div id="preloader"></div>
    <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-headset"></i></a>
  <!-- Vendor JS Files -->
